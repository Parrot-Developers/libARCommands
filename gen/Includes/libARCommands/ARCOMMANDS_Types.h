...
typedef enum
{
    ...
    ARCOMMANDS_FOLLOW_ME_TYPE_LOOK_AT,    ///< LookAt follow me type
    ARCOMMANDS_FOLLOW_ME_TYPE_GEOGRAPHIC,    ///< Follow the target keeping the same vector
    ARCOMMANDS_FOLLOW_ME_TYPE_RELATIVE,    ///< Follow the target keeping the same orientation to its direction
...
typedef enum
{
    ...
    ARCOMMANDS_FOLLOW_ME_ANIM_TYPE_SPIRAL,    ///< Current follow me animation is spiral
    ARCOMMANDS_FOLLOW_ME_ANIM_TYPE_SWING,    ///< Current follow me animation is swing
    ARCOMMANDS_FOLLOW_ME_ANIM_TYPE_BOOMERANG,    ///< Current follow me animation is boomerang
    ARCOMMANDS_FOLLOW_ME_ANIM_TYPE_CANDLE,    ///< Current follow me animation is candle
    ARCOMMANDS_FOLLOW_ME_ANIM_TYPE_DOLLY_SLIDE,    ///< Current follow me animation is dolly slide
...
typedef enum
{
    ...
    ARCOMMANDS_FOLLOW_ME_TYPES_AVAILABLE_LOOK_AT,    ///< LookAt available, no other types
    ARCOMMANDS_FOLLOW_ME_TYPES_AVAILABLE_LOOK_AND_FOLLOW,    ///< LookAt, Geographic and Relative follow me are available
...
typedef enum
{
    ...
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_TAKINGOFF,    ///< Taking off state
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_FLYING,    ///< Flying state
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_LANDING,    ///< Landing state
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_EMERGENCY,    ///< Emergency state
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_USERTAKEOFF,    ///< User take off state. Waiting for user action to take off.
    ARCOMMANDS_JUMPINGSUMO_PILOTINGSTATE_FLYINGSTATECHANGED_STATE_INIT,    ///< Initializing state (user should let the drone steady for a while)
...
typedef enum
{
    ...
    ARCOMMANDS_MINIDRONE_PILOTING_FLYINGMODE_MODE_PLANE_FORWARD,    ///< Fly as a plane in forward mode
    ARCOMMANDS_MINIDRONE_PILOTING_FLYINGMODE_MODE_PLANE_BACKWARD,    ///< Fly as a plane in backward mode
...
typedef enum
{
    ...
    ARCOMMANDS_MINIDRONE_PILOTINGSTATE_FLYINGMODECHANGED_MODE_PLANE_FORWARD,    ///< Fly as a plane in forward mode
    ARCOMMANDS_MINIDRONE_PILOTINGSTATE_FLYINGMODECHANGED_MODE_PLANE_BACKWARD,    ///< Fly as a plane in backward mode
