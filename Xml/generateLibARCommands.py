...
jfile.write ('        int totalSize = oldData.length;\n')
...
jfile.write ('            inUse = nativeCopyFromArray (oldData, pdata, dataTotalLength);\n')
jfile.write ('        }\n')
jfile.write ('    }\n')
jfile.write ('\n')
jfile.write ('    /**\n')
...
jfile.write ('    private native boolean nativeCopyFromArray (byte [] oldData, long pdata, int dataLen);\n')
...
cfile.write (JNI_FUNC_PREFIX+ JNIClassName+ '_nativeCopyFromArray ('+ JNI_FIRST_ARGS+ ', jbyteArray oldData, jlong c_pdata, jint j_dataLen)\n')
cfile.write ('{\n')
...
cfile.write ('    if (valid == JNI_TRUE)\n')
cfile.write ('    {\n')
cfile.write ('        memcpy ((uint8_t *) (intptr_t) c_pdata, j_pdata, len);\n')
cfile.write ('    }\n')
cfile.write ('\n')
cfile.write ('    if (j_pdata != NULL)\n')
cfile.write ('    {\n')
