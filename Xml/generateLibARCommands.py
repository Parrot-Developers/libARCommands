...
cfile.write ('    ' + AREnumName (LIB_MODULE, FIL_SUBMODULE, FIL_STATUS_ENAME) + ' localError = ' + AREnumValue (LIB_MODULE, FIL_SUBMODULE, FIL_ERROR_ENAME, 'OK') + ';\n')
...
cfile.write ('        if (retFilter != NULL)\n')
cfile.write ('        {\n')
cfile.write ('            ARCOMMANDS_Filter_Delete (&retFilter);\n')
...
for proj in allProjects:
    ...
    for cl in proj.classes:
        ...
        for cmd in cl.cmds:
            ...
            cfile.write ('{\n')
            cfile.write ('    ' + AREnumName (LIB_MODULE, FIL_SUBMODULE, FIL_STATUS_ENAME) + ' retError = ' + AREnumValue (LIB_MODULE, FIL_SUBMODULE, FIL_ERROR_ENAME, 'OK') + ';\n')
            cfile.write ('    if (filter == NULL)\n')
            cfile.write ('    {\n')
